...
module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c44 = function(proximity) {
                return proximity;
            },
        peg$c45 = "^",
        peg$c46 = { type: "literal", value: "^", description: "\"^\"" },
        peg$c47 = function(boost) {
                return boost;
            },
        peg$c48 = function(fuzziness) {
        ...
        peg$c53 = function(sign, val) {
              if (!sign || sign === '+') {
                sign = '';
              }
              console.log('DECIMAL', sign, val);
              return parseFloat(sign + "0." + val);
            },
        peg$c54 = function(sign, val) {
              if (!sign || sign === '+') {
                sign = '';
              }
              console.log('INT', sign, val);
        ...
        peg$c61 = function(term_min, term_max) {
                return {
                    term_min: term_min,
                    term_max: term_max,
                    inclusive: true,
        ...
        peg$c69 = function(term_start, term) {
              console.log('RANGE UNQUOTED TERM', term_start, term);
              return term_start + term;
            },
        peg$c70 = /^[^: \t\r\n\f{}()"\/\^~[\]]/,
        ...
        peg$c83 = function() { return 'OR'; },
        peg$c84 = "&&",
        peg$c85 = { type: "literal", value: "&&", description: "\"&&\"" },
        peg$c86 = function() { return 'AND'; },
        peg$c87 = "!",
