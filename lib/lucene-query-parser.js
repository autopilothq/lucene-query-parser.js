...
module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c87 = "0.",
        peg$c88 = { type: "literal", value: "0.", description: "\"0.\"" },
        peg$c89 = /^[0-9]/,
        peg$c90 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c91 = function(sign, val) {
              if (!sign || sign === '+') {
                sign = '';
              }
              return parseFloat(sign + "0." + val);
            },
        peg$c92 = function(sign, val) {
              if (!sign || sign === '+') {
                sign = '';
              }
              return parseInt(sign + val, 10);
            },
        peg$c93 = "[",
        peg$c94 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c95 = "TO",
        peg$c96 = { type: "literal", value: "TO", description: "\"TO\"" },
        peg$c97 = "]",
        peg$c98 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c99 = function(term_min, term_max) {
                return {
                    term_min: term_min,
                    term_max: term_max,
                    inclusive: true,
        ...
        peg$c104 = function(term_min, term_max) {
                return {
                    term_min: term_min,
                    term_max: term_max,
                    inclusive: false,
        ...
        peg$c106 = function(term_min, term_max) {
                return {
                    term_min: term_min,
                    term_max: term_max,
                    inclusive: false,
        ...
        peg$c107 = function(term_start, term) {
        ...
        peg$c112 = function(operator) {
                return operator;
            },
        peg$c113 = "OR",
        peg$c114 = { type: "literal", value: "OR", description: "\"OR\"" },
        peg$c115 = "AND",
        peg$c116 = { type: "literal", value: "AND", description: "\"AND\"" },
        peg$c117 = "NOT",
        peg$c118 = { type: "literal", value: "NOT", description: "\"NOT\"" },
        peg$c119 = "||",
        peg$c120 = { type: "literal", value: "||", description: "\"||\"" },
        peg$c121 = function() { return 'OR'; },
        peg$c122 = "&&",
        peg$c123 = { type: "literal", value: "&&", description: "\"&&\"" },
        peg$c124 = function() { return 'AND'; },
        peg$c125 = "!",
        peg$c126 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c127 = function() { return 'NOT'},
    ...
    function peg$parserange_term() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parsedecimal_or_int_exp();
      }
